...
export default async function AdminPage() {
  ...
  return <main>
    ...
    <section className="section"><div className="container">
      ...
      <section style={{border:'1px solid #eadfd8',borderRadius:16,padding:20,background:'#fff',marginTop:28}}><h2 style={{color:'var(--burgundy)',marginTop:0}}>Storefront header & homepage</h2><p style={{color:'var(--muted)',marginTop:6}}>Edit the announcement, utility links, social links, main menu, hero banners and trust features. Keep the same field names and valid URLs when updating.</p><form action={updateStorefrontContent} style={{display:'grid',gap:12}}><label>Storefront configuration (JSON)<textarea name="storefront_config" defaultValue={JSON.stringify(storefront?.config ?? {}, null, 2)} rows={28} style={{fontFamily:'ui-monospace, SFMono-Regular, Menlo, monospace'}} required/></label><div><button className="btn btn-primary" type="submit">Save storefront settings</button></div></form></section>
