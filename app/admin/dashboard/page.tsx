...
export default async function AdminDashboardPage(){
  ...
  const lowStockVariants=variants.filter((v:any)=>Number(v.stock_quantity)<=Number(v.reorder_threshold??5)).length
  const outOfStockVariants=variants.filter((v:any)=>Number(v.stock_quantity)===0).length
