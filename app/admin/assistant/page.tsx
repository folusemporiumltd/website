...
export default async function AIVirtualAssistantPage(){
  ...
  const [{count:openTasks},{count:pendingApprovals},{data:activity}]=await Promise.all([
  ...
  return <main className="admin-dashboard-shell">
    ...
    <section className="section" style={{paddingTop:42}}><div className="container">
      ...
      <AssistantClient initialMessages={[]} openTasks={openTasks??0} pendingApprovals={pendingApprovals??0} recentActivity={activity??[]}/>
