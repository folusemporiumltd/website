...
export default function CheckoutPage() {
  ...
  if (authChecking) return <main><section className="section"><div className="container empty"><p>Checking your account…</p></div></section></main>

  if (!authenticated) return <main><section className="section"><div className="container empty"><div className="eyebrow">One quick step before payment</div><h1>Create your Folus Emporium account</h1><p>Your cart is saved. Please register or sign in before continuing to Paystack. This helps us securely connect your order to your customer account.</p><div style={{display:'flex',gap:12,justifyContent:'center',flexWrap:'wrap',marginTop:20}}><Link className="btn btn-primary" href="/login?next=/checkout">Register / Sign in</Link><Link className="btn btn-outline" href="/cart">Back to cart</Link></div></div></section></main>
