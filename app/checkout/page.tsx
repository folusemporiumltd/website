...
export default function CheckoutPage(){
 ...
 async function applyCoupon(){
  setCouponBusy(true);setCouponMsg('Checking…');setDiscount(0)
  try {
  ...
  }catch{setDiscount(0);setCouponMsg('Unable to check coupon. Please try again.')}finally{setCouponBusy(false)}
 }
