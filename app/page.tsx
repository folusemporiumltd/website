    ...
    <main>
      ...
      <footer className="footer luxury-footer">
        <div className="container footer-links-grid">
          ...
          <div className="footer-contact"><h3>Contact Information</h3><a href="mailto:folusemporium@gmail.com"><ContactIcon type="email"/>folusemporium@gmail.com</a><a href="mailto:info@folusemporium.com"><ContactIcon type="email"/>info@folusemporium.com</a><a href="tel:+2349168157255"><ContactIcon type="phone"/>+234 916 815 7255</a><a href="https://wa.me/2349168157255"><ContactIcon type="whatsapp"/>WhatsApp: +234 916 815 7255</a><p><ContactIcon type="address"/>Alarere, Ibadan, Oyo State</p></div>
        </div>
        <div className="container footer-social-row"><div><b>Follow Folus Emporium</b><div className="footer-socials"><a href="https://www.facebook.com/folusemporiumltd" aria-label="Facebook">f</a><span aria-label="Instagram">◎</span><a href="https://www.tiktok.com/@folusemporium25" aria-label="TikTok">♪</a><span aria-label="YouTube">▶</span><span aria-label="LinkedIn">in</span></div></div><div className="payment-icons"><span>Paystack</span><span>VISA</span><span>Mastercard</span></div></div>
