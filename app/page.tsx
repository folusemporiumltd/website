...
const fallback = { announcement: 'Serving homes & businesses across Nigeria.', utilityLinks: [['Track Order','/account'],['FAQ','#faq'],['Contact Us','/contact']] as [string,string][], social: { facebook: 'https://www.facebook.com/folusemporiumltd', tiktok: 'https://www.tiktok.com/@folusemporium25', whatsapp: 'https://wa.me/2349168157255', instagram: '' }, navigation: [['Home','/'],['Shop','/shop'],['Categories','/shop'],['About Us','/about'],['Blog','/blog'],['Contact Us','/contact']] as [string,string][], trust: [['100% Natural','No preservatives','leaf'],['Premium Quality','Carefully sourced','shield'],['Fast Delivery','Across Nigeria','truck'],['Dedicated Support',"We're here to help",'support']] as [string,string,string][], slides: [] as {title:string;text:string;cta:string;href:string;image:string}[] }
