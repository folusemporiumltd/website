...
const promises = [
  { number: '01', title: 'NATURAL', description: 'Thoughtfully selected ingredients and food products.', icon: 'leaf' },
  { number: '02', title: 'QUALITY', description: 'Careful processing and packaging standards.', icon: 'shield' },
  { number: '03', title: 'CONVENIENCE', description: 'Practical products that make everyday cooking easier.', icon: 'sparkles' },
  { number: '04', title: 'TRUST', description: 'A customer-first experience from order to delivery.', icon: 'heart' },
]
...
function PromiseIcon({ type }: { type: string }) {
  ...
  if (type === 'sparkles') return <svg viewBox="0 0 24 24" aria-hidden="true" {...common}><path d="m12 3 1.4 4.1L17.5 8.5l-4.1 1.4L12 14l-1.4-4.1-4.1-1.4 4.1-1.4L12 3Z"/><path d="m19 13 .7 2.3L22 16l-2.3.7L19 19l-.7-2.3L16 16l2.3-.7L19 13Z"/><path d="m5 14 .6 1.8L7.5 16l-1.9.7L5 18.5l-.6-1.8L2.5 16l1.9-.7L5 14Z"/></svg>
