    ...
    <main>
      ...
      <footer className="footer luxury-footer">
        <div className="container footer-links-grid">
          ...
          <div><h3>Customer Service</h3><Link href="/contact">Contact Us</Link><Link href="/faq">FAQs</Link><Link href="/shipping-policy">Shipping Policy</Link><Link href="/return-policy">Return Policy</Link><Link href="/privacy-policy">Privacy Policy</Link><Link href="/terms-and-conditions">Terms & Conditions</Link></div>
        ...
        <div className="container footer-social-row"><div><b>Follow Folus Emporium</b><div className="footer-socials"><a href="https://www.facebook.com/folusemporiumltd" target="_blank" rel="noreferrer" aria-label="Facebook">f</a><a href="https://www.tiktok.com/@folusemporium25" target="_blank" rel="noreferrer" aria-label="TikTok">♪</a></div></div><div className="footer-payment-logos" role="group" aria-label="Accepted payment methods" style={{display:'flex',alignItems:'center',flexWrap:'nowrap',gap:14,padding:'10px 12px',background:'#fffdf9',border:'1px solid #e2ad46',borderRadius:8,maxWidth:'100%',boxSizing:'border-box'}}><img src="/Paystack.png" alt="Paystack" width={116} height={28} style={{display:'block',width:116,height:28,objectFit:'cover',flexShrink:1,minWidth:0,mixBlendMode:'multiply'}}/><img src="/visa-and-mastercard-logo-26.png" alt="Visa and Mastercard" width={132} height={34} style={{display:'block',width:132,height:34,objectFit:'contain',flexShrink:1,minWidth:0,mixBlendMode:'multiply'}}/></div></div>
        <div className="container copyright footer-bottom"><img src="https://boaaiskncrfmaismhqno.supabase.co/storage/v1/object/public/product-images/folus-emporium-horizontal-logo.png" alt="Folus Emporium"/><span>© 2026 Folus Emporium. All Rights Reserved. · Nature’s Goodness, Purely Yours.</span></div>
      </footer>
    </main>
  )
}
