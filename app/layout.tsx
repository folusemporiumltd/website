...
import FolusVA from '@/components/folus-va'
...
export default function RootLayout({children}:Readonly<{children:React.ReactNode}>){return <html lang="en-NG"><body><CartProvider><WishlistProvider>{children}<StorefrontFooter/><FolusVA/><FloatingWhatsApp/><AdminFormLoading/></WishlistProvider></CartProvider><GoogleAnalytics/><Analytics/></body></html>}
