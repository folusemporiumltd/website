...
export const metadata: Metadata = {
  title: 'Careers | Folus Emporium',
  description: 'Explore career opportunities and learn what it means to work with Folus Emporium.',
}
...
export default function CareersPage() {
  return <main>
    ...
    <section className="content-hero"><div className="container content-hero-grid"><div><div className="eyebrow">Careers</div><h1>Grow with a business that is still being built.</h1><p>Folus Emporium is developing its food, ecommerce, operations and customer-service capabilities. We value practical thinkers who are willing to learn, take ownership and help improve the way work gets done.</p><div className="hero-actions"><a className="btn btn-primary" href="mailto:folusemporium@gmail.com?subject=Career%20Interest%20-%20Folus%20Emporium">Send your CV</a><Link className="btn btn-outline" href="/about">Learn about us</Link></div></div><div className="content-brand-card"><span className="eyebrow">Working at Folus Emporium</span><strong>Small team. Real responsibility. Visible impact.</strong><p>As we grow, each team member has an opportunity to contribute ideas, strengthen systems and improve customer outcomes.</p></div></div></section>
    ...
    <section className="section"><div className="container"><div className="section-head"><div><div className="eyebrow">Current openings</div><h2>No publicly advertised vacancy at the moment.</h2></div></div><div className="story-panel"><p>We do not currently list a specific open position on this page. If you would like to be considered for future opportunities, you may send a concise CV and a short introduction explaining the area in which you can contribute.</p><p>Please include your location, relevant experience, availability and the kind of role you are interested in. We will only contact candidates when there is a suitable opportunity.</p><a className="btn btn-primary" href="mailto:folusemporium@gmail.com?subject=Career%20Interest%20-%20Folus%20Emporium">Email your application</a></div></div></section>
