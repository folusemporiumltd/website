...
export default async function ShopPage({ searchParams }: { searchParams: Promise<{ category?: string }> }) {
  ...
  const filteredProducts = selectedCategory ? visibleProducts.filter(p => p.category_id === selectedCategory.id) : visibleProducts
  const activeVariants = (variants ?? []) as Variant[]
